...
const Education = () => {
  return (
    <motion.section id="education" className="py-20 border-b border-neutral-800 scroll-mt-24" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.5 }}>
